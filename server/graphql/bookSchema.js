...
var GrapQLObjectType = require("graphql").GraphQLObjectType;
...
var bookType = new GrapQLObjectType({
    name: "book",
    fields: function() {
        return {
            _id: {
...
var queryType = new GrapQLObjectType({
    name: "Query",
    fields: function() {
        return {
            books: {
    ...
    fields: function() {
        return {
            ...
            removeBook: {
                ...
                resolve(root, params) {
                    const remBook = BookModel.findByIdAndDelete(params.id).exec();
                    if(!remBook) {
                        throw new Error("Error");
                    }
                    return remBook;
